  ...
  <template v-else>
    <div class="overview-page">
      ...
      <UniverseManager
        ...
        :universe-search-page="dashboard.universeSearchPage"
        :universe-search-page-size="dashboard.universeSearchPageSize"
        :universe-search-total="dashboard.universeSearchTotal"
        ...
        @page-search="dashboard.setUniverseSearchPage"
